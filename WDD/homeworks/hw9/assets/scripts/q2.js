...
function unhideLightbox3() {
	unhideLightbox(document.getElementById("doggo3"))
}
...
let lbOverlayID = document.getElementById("lightbox-overlay");
lbOverlayID.onclick = closeAllLightboxes;